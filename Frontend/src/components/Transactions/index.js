...
const Transactions = () => {
    ...
    useEffect(()=>{
        const getTransactions = async ()=>{
            const list = await axios.get(`https://roxiler-backend-himanshusharma-projects.vercel.app/transactions?month=${selectedMonth}&page=${page}&search=${searchInput}&perPage=10`)
